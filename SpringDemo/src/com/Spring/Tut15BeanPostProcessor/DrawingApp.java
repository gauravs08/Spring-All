...
public class DrawingApp {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context =new ClassPathXmlApplicationContext("com/Spring/Tut15BeanPostProcessor/SpringDraw.xml");
		
		//AbstractApplicationContext is used for hookup for callback mode 
		//AbstractApplicationContext context =new ClassPathXmlApplicationContext("com/Spring/Tut15BeanPostProcessor/SpringDraw.xml");
